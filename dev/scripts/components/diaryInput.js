            ...
            <div className="diary-entry">
                <form onSubmit={props.onSubmit}>
                    ...
                    <div className="diaryEntry-header">
                        ...
                        <div className="diaryEntry-item diaryInput-item">
                            <h3>Bake Date</h3>
                            <input type="date" id="bakedate" onChange={props.onChange} value={props.data.bakedate} />
                        </div>
                    </div>
                    ...
                    <div className="diaryEntry-section-small">
                        <div className="diaryEntry-item diaryInput-item">
                            <h3>Leaven</h3>
                            <textarea type="text" id="leaven" onChange={props.onChange} value={props.data.leaven} />
                        </div>

                        <div className="diaryEntry-item diaryInput-item">
                            <h3>Dough</h3>
                            <textarea type="text" id="dough" onChange={props.onChange} value={props.data.dough} />
                        </div>
                    </div>
                    ...
                    <div className="diaryEntry-section-large">
                        <div className="diaryEntry-item diaryInput-item">
                            <h3>Retrospective</h3>
                            <textarea type="text" id="retrospective" onChange={props.onChange} value={props.data.retrospective} />
                        </div>
                    </div>
